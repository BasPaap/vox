...
void Bas::ScrollingList::writeToDisplay(Adafruit_SSD1306 &display)
{
	...
	Serial.print("Index: ");
	Serial.print(selectedItemIndex);
	Serial.print(" listY: ");
	Serial.print(listYPosition);
	Serial.print(" minY: ");
	Serial.print(getMinYPosition());
	Serial.print(" actual: ");
	Serial.println(constrain(listYPosition, getMinYPosition(), getMaxYPosition()));
